...
<div class="container contact-form">
            ...
            <form method="post" action="/productos">
                <h3>Agrege un nuevo producto</h3>
               <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="Contenido" class="form-control" placeholder="Contenido del producto*" />
                        </div>
                        <div class="form-group">
                            {{csrf_field()}}
                            <input style="background-color: #b7ce00" type="submit" name="btnSubmit" class="btnContact" value="Agregar Producto" />
                        </div>
